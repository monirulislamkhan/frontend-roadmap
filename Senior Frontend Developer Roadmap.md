...
_Started: July 2026 | Last updated: 15 July 2026 | Commitment: 6–8 hours a week | 📋 Weekly progress: [weekly-log.md](./weekly-log.md)_
...
- [ ] **Week 1 warm-up: values, operators, conditions, loops** _(the base under everything — do not skip it just because it looks easy)_
